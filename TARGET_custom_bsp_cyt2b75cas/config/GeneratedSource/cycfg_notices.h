...
#if !defined(CYT2B75CAS)
#error "Unexpected MPN; expected DEVICE:=CYT2B75CAS. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(CYT2B75CAS) */
